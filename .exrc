...
inoremap <expr> <C-K> pumvisible() ? "\" : "\<S-Tab>"
...
nmap  dx :VimspectorReset
nmap  dd :call vimspector#Launch()
nnoremap  <F5> :w  :!make && ./runner 
...
nnoremap c<C-L> :rightb vsp new
nnoremap c :rightb vsp new
nnoremap c<C-K> :abo sp new
nnoremap c :abo sp new
nnoremap c<C-J> :bel sp new
nnoremap c<NL> :bel sp new
nnoremap c<C-H> :lefta vsp new
nnoremap c :lefta vsp new
...
nnoremap <silent> <C-T> :FloatermToggle
tnoremap <silent> <C-L> :FloatermNext
tnoremap <silent> <C-H> :FloatermPrev
tnoremap <silent> <C-T> :FloatermToggle
map <C-L> l
map <C-K> k
map <C-J> j
nmap <C-H> h
...
set ruler
set runtimepath=~/.vim,~/.vim/pack/themes/start/dracula,~/.vim/plugged/vim-fugitive,~/.vim/plugged/fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/vim-startify,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-airline-themes,~/.vim/plugged/vim-floaterm,~/.vim/plugged/nerdtree,~/.vim/plugged/nerdtree-git-plugin,~/.vim/plugged/vim-nerdtree-syntax-highlight,~/.vim/plugged/vim-commentary,~/.vim/plugged/vim-easymotion,~/.vim/plugged/coc.nvim,~/.vim/plugged/dracula,~/.vim/plugged/vim-cpp-enhanced-highlight,~/.vim/plugged/omnisharp-vim,~/.vim/plugged/ale,~/.vim/plugged/ultisnips,~/.vim/plugged/vimspector,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,~/.vim/pack/themes/start/dracula/after,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/plugged/nerdtree-git-plugin/after,~/.vim/plugged/vim-nerdtree-syntax-highlight/after,~/.vim/plugged/dracula/after,~/.vim/plugged/vim-cpp-enhanced-highlight/after,~/.vim/plugged/ultisnips/after,~/.vim/after
set scrolloff=10
set shiftwidth=4
